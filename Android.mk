...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/monkecodegen/include' -DID='"GorillaCosmetics"' -DVERSION='"1.2.3"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
