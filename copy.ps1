...
& adb push libs/arm64-v8a/libgorillacosmetics.so /sdcard/Android/data/com.AnotherAxiom.GorillaTag/files/mods/libgorillacosmetics.so
...
#& adb logcat -c
#& adb logcat | Select-String "GorillaCosmetics"
